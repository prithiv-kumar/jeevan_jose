        ...
        <aside className="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
            <div className="flex flex-col justify-between h-full">
                <div className="flex-grow">
                    <div className="px-4 py-3 text-center border-b flex items-center">
                        <img
                            className="mx-auto h-16 w-auto invert "
                            src={logo}
                            alt="Your Company"
                        />
                        <h1 className="text-xl font-bold leading-none"> Task Manager </h1>
                    </div>
                    <div className="p-4">
                        <ul className="space-y-1">

                            <li>
                                <Link to="/projects" className={sideactive === "projects" ? "flex bg-yellow-200 hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4" : "flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4"}>
                                    ...
                                    </svg>Projects(Assigned)
                                </Link>
                            </li>
                            <li>
                                <Link to="/tasks" className={sideactive === "tasks" ? "flex bg-yellow-200 hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4" : "flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4"}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/projects/self" className={sideactive === "cprojects" ? "flex bg-yellow-200 hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4" : "flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4"}>
                                    ...
                                    </svg>Projects(Created)
                                </Link>
                            </li>
                        </ul>
                    </div>
                </div>
                <div className="p-4 flex cursor-pointer hover:bg-yellow-200 rounded-xl font-bold text-sm text-gray-900 py-3 px-4" onClick={() => { handleLogout() }}>
